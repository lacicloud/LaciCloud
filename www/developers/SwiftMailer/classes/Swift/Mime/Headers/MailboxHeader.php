    ...
    private function _assertValidAddress($address)
    {
        if (!preg_match('/^'.$this->getGrammar()->getDefinition('addr-spec').'$/D',
            ...
            //throw new Swift_RfcComplianceException(
             ...
             error_log("\n".date('l jS \of F Y h:i:s A').':'." Severity: "."LOW"." Message: "."Non-RFC 2822 compliant email address.. address: ".$address." Error Id: "."21"." File: ".$caller['file']." Line: ".$caller['line']." IP: ".$_SERVER["REMOTE_ADDR"]."\n\n",3,"/var/ftp/logs/website_custom.txt");
        }
    }
}
