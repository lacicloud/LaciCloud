...
curl -k https://ipv4.ident.me | tac | tac | $PWD/gad.sh -a $api_key -d lacicloud.net -r "@"
curl -k https://ipv4.ident.me | tac | tac | $PWD/gad.sh -a $api_key -d lacicloud.net -r "A"

curl -k https://ipv6.ident.me | tac | tac | $PWD/gad.sh -6 -s -a $api_key -d lacicloud.net -r "*"
curl -k https://ipv6.ident.me | tac | tac | $PWD/gad.sh -6 -s -a $api_key -d lacicloud.net -r "@"
curl -k https://ipv6.ident.me | tac | tac | $PWD/gad.sh -6 -s -a $api_key -d lacicloud.net -r "AAAA"
